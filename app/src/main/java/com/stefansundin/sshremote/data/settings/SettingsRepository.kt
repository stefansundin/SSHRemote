...
class SettingsRepository(context: Context) {
    ...
    private object PreferencesKeys {
        ...
        val REUSE_SHELL = booleanPreferencesKey("reuse_shell")
    ...
    val reuseShell: Flow<Boolean> = dataStore.data
        .map { preferences ->
            preferences[PreferencesKeys.REUSE_SHELL] ?: true
        }

    suspend fun setReuseShell(reuseShell: Boolean) {
        dataStore.edit { preferences ->
            preferences[PreferencesKeys.REUSE_SHELL] = reuseShell
        }
    }
