...
fun EditMouseCommandsDialog(
    ...
    AlertDialog(
        title = { Text(stringResource(R.string.edit_mouse_commands)) },
        text = {
            Column(
                ...
                val mouseKeys = listOf(
                    ...
                    RemoteControlKey.MOUSE_LEFT_DOWN,
                    RemoteControlKey.MOUSE_LEFT_UP,
                    RemoteControlKey.MOUSE_RIGHT_DOWN,
                    RemoteControlKey.MOUSE_RIGHT_UP,
